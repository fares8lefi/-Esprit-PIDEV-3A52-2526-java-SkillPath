...
public class EditCourseController implements Initializable {
    ...
    public void setCourse(Course course) {
        ...
        comboCategory.setValue(course.getCategory());
        lblErrorCategory.setVisible(false); lblErrorCategory.setManaged(false);
        txtDescription.setText(course.getDescription());
        lblErrorDescription.setVisible(false); lblErrorDescription.setManaged(false);
    ...
    private void handleSubmit(ActionEvent event) {
        if (isInputValid()) {
            ...
            currentCourse.setCategory(comboCategory.getValue());
            currentCourse.setDescription(txtDescription.getText());

            // Handle Image Update (Bulletproof Path)
            if (selectedImageFile != null) {
                ...
                try {
                    ...
                    currentCourse.setImage(fileName);
                } catch (IOException e) {
                    System.err.println("Erreur mise à jour image : " + e.getMessage());
                }
            }
